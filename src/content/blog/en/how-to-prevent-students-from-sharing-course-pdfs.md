...
| Use case | Useful control |
|---|---|
| 7-day workshop notes | Expiry after the event |
| Sample lesson PDF | View limit or short expiry |
| Homework packet | Class-term access window |
| Paid exam-prep material | Expiry plus device control |
| Refund or chargeback | Revoke future access |

With [MaiPDF online sharing](https://maipdf.com), a creator can use browser-based controls such as expiry, view limits, access records, and watermarking without asking every student to install an app.
...
In that case, use [MaiPDF App DRM](https://drm.maipdf.com).
...
![MaiPDF App DRM protected file result for course PDF security](/app-screenshots/maipdf-app-drm-pack-result-en.png)
...
## Recommended MaiPDF setup by course type

| Course material | Recommended setup |
|---|---|
| Free checklist | Online link, optional watermark |
| Trial lesson | Online link with short expiry |
| Workshop handout | Online link with expiry and tracking |
| Paid workbook | App DRM / `.maipdf`, watermark, revocation |
| Exam-prep PDF | App DRM / `.maipdf`, device binding, expiry |
| Corporate training manual | App DRM / `.maipdf`, team licenses, revocation |
| Certification material | App DRM / `.maipdf`, device control, watermarking |
...
If the PDF is a free handout or sample lesson, use [MaiPDF Online Cloud Sharing](https://maipdf.com) with watermarks, expiry, and tracking.

If the PDF is a paid workbook, exam-prep pack, certification file, or corporate training manual, use [MaiPDF App DRM](https://drm.maipdf.com) and distribute it as a protected `.maipdf` file with device binding, revocation, and screenshot-aware reading.
