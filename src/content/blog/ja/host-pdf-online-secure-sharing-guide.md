...
![メッセージングアプリで共有されるPDF](/maipdf2026/show_off/shareandsend.png)
...
![ブラウザでのネイティブPDF表示](/maipdf2026/MaiPDF_settings_expiration_telegram.png)
...
![セキュリティ設定パネル](/maipdf2026/pdf%20native%20view%20on%20ui.png)
...
- **地理データ：** Visitor IDアドレスから閲覧場所を特定
- **デバイス情報：** どのデバイスが文書にアクセスしたかを追跡

![PDFアクセス追跡インターフェース](/maipdf2026/how_to_fill_access_record_for_check.png)
...
- アクセス場所を制限するVisitor IDアドレス制限を有効化
