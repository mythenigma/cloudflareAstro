...
description: >-
  고급 보기 옵션, 문서 보호 및 추적 기능을 통해 PDF를 온라인에서 안전하게 공유하는 방법을 알아보세요. 이메일 첨부 파일 문제와
  작별하세요.
pubDate: May 15 2025
...
![메시징 앱으로 PDF 공유](/maipdf2026/show_off/shareandsend.png)
...
![브라우저에서 기본 PDF 보기](/maipdf2026/MaiPDF_settings_expiration_telegram.png)
...
![보안 설정 패널](/maipdf2026/pdf%20native%20view%20on%20ui.png)
...
- **지리적 데이터:** Visitor ID 주소로 조회 위치 식별
- **기기 정보:** 어떤 기기가 문서에 접근했는지 추적

![PDF 접근 추적 인터페이스](/maipdf2026/how_to_fill_access_record_for_check.png)
...
- 접근 위치를 제한하는 Visitor ID 주소 제한 활성화
