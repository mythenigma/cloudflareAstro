...
<div class="faq-container">
  ...
  <div class="faq-item">
    <h4>统计日志保存多久？</h4>
    <p>没有按版本区分的保留期。一般规律是：<strong>约三个月无人读取</strong>的文件会在服务器例行清理中被清除。需要长期留底的资料，请自行保存原件。</p>
  </div>
  <div class="faq-item">
    <h4>是否支持 API 集成？</h4>
    <p><strong>目前没有对外开放的 API。</strong>MaiPDF 通过网页上传与管理，没有企业版，也没有可对接自有系统的接口。</p>
  </div>
</div>
...
- [二维码一扫，PDF随时随地看](/blog/cn/qr-code-pdf-sharing)
- [在微信分享PDF，用MaiPDF简单又安全](/blog/cn/wechat-pdf-sharing)
- [MaiPDF动态水印功能 — 精准追踪，让每个阅读行为可回溯](/blog/cn/share-pdf-securely)
