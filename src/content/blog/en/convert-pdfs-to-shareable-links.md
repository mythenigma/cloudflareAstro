...
|--|-----------------|----------------|
| Update after sending | Impossible | Swap file in Control Center |
| Revoke access | Impossible | One click in Control Center |
| Did they read it? | No visibility | Access log with timestamps |
