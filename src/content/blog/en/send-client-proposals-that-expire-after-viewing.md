...
description: "How to use expiring proposal links to protect pricing and strategy while keeping client delivery simple. Setup guide, settings presets, and follow-up playbook based on open data."
pubDate: "Apr 4 2026"
heroImage: "/maipdf2026/MaiPDF_settings_expiration_telegram.png"
tags: ["client proposals", "secure sharing", "business security", "PDF expiration", "MaiPDF"]
showDefaultCta: true
---
...
<div class="intro-panel">
  <p>A proposal link that never expires gives the client, their competitors, and anyone they forward to permanent access to your pricing and strategy. An expiring link solves this without adding friction to delivery. The client opens it the same way — they just can't access it after the window closes.</p>
</div>
...
1. Upload your proposal PDF at [maipdf.com](https://maipdf.com)
2. Set download **off** (view-only), expiry (e.g., 7 days), and view limit (e.g., 10 opens)
3. Optionally enable email verification to identify the opener
4. Click **Create Secure Link** and paste it in your outreach email
...
![Configure expiry, view limit, and download settings before sending](/maipdf2026/MaiPDF_settings_expiration_telegram.png)
...
MaiPDF logs every open with a timestamp. Check [Control Center](https://www.maipdf.com/6/control-center.html) after sending:
...
![Access records — see exactly when the client opened your proposal](/maipdf2026/page_redirect_to_accessRecord.png)
