...
<div class="steps-container">
    ...
    <ul>
      ...
      <li>根据分发场景选择合适的水印内容组合：
        <ul>
          ...
          <li>高敏感材料：完整追踪信息（访客标识 + 时间 + 查看者标识）</li>
        </ul>
      </li>
  ...
  <div class="step">
    ...
    <img src="/maifle/阅读记录查询结果示例.png" alt="打开统计监控" class="step-image">
  </div>
</div>
