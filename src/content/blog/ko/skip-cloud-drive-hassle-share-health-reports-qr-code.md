...
![QR 코드와 PDF 링크 결과](/maipdf2026/Result_of_qr_link.png)
...
| 전달되면 제어 불가             | 보기 제한, 만료 날짜, Visitor ID 추적      |
...
2.  **보기 규칙 설정**—14일 동안 3회 열람 제한 또는 원하는 경우 특정 Visitor ID 범위로 잠급니다.
...
![업로드 섹션 인터페이스](/maipdf2026/Maipdf_LANDING_PAGE.png)
...
![보안 설정 패널](/maipdf2026/MaiPDF_settings_expiration_telegram.png)
...
![브라우저에서 PDF 네이티브 뷰](/maipdf2026/show_off/showpdf.png)
...
![문서를 본 사람 추적](/maipdf2026/page_redirect_to_accessRecord.png)
