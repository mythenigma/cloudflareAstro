...
<div class="features-table">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>アクセスログ送信</td>
        <td>オンライン時にVisitor ID、時間、デバイスをアップロード</td>
        <td>無料 (<10,000回閲覧)</td>
      </tr>
      <tr>
...
<div class="steps-container">
  <div class="step-item">
    ...
    <div class="step-content">
      ...
      <img src="/maipdf2026/flowchart/en-access-control-decision.svg" alt="PDFアップロードインターフェース" class="small">
    </div>
  </div>
  <div class="step-item">
    ...
    <div class="step-content">
      ...
      <img src="/offlinepages/upload_section_offline_maipdf.png" alt="セキュリティ設定インターフェース" class="small">
    </div>
  </div>
  <div class="step-item">
    ...
    <div class="step-content">
      ...
      <img src="/offlinepages/security_setting.png" alt="オフラインパッケージダウンロード結果" class="small">
    </div>
  </div>
</div>
