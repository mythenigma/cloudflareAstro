...
```mermaid
flowchart TD
    Start([Start]) --> A[Vertrags-PDF hochladen]
    ...
    F -->|Ja| G[Kundeninteressen analysieren]
    F -->|Nein| H[Kunde erinnern]
    G --> I{Ist Vertrag unterschrieben?}
    H --> I
    I -->|Ja| J[Ein-Klick-Deaktivierung]
    I -->|Nein| K[Link aktiv lassen]
    J --> L[Vertragsvertraulichkeit schützen]
    L --> End([Ende])
    K --> D
```
