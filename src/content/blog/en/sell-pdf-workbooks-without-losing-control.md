...
With [MaiPDF Online Cloud Sharing](https://maipdf.com), the creator uploads a PDF and shares a managed reading link or QR code instead of a raw file.
...
For higher-value products, use [MaiPDF App DRM](https://drm.maipdf.com).
...
![MaiPDF App DRM pack result for protected workbook delivery](/app-screenshots/maipdf-app-drm-pack-result-en.png)
...
For a deeper refund-specific workflow, see [How to Revoke Course PDF Access After a Refund](/blog/en/how-to-revoke-course-pdf-access-after-refund).

## A practical selling workflow

A safer workbook-selling workflow looks like this:

1. Create the workbook PDF.
2. Decide if it is a lightweight resource or a high-value product.
3. Use Online Cloud Sharing for samples and low-risk downloads.
4. Use App DRM / `.maipdf` for paid core workbooks.
5. Add watermarking so leaks are traceable.
6. Set expiry or device limits where appropriate.
7. Send buyers clear access instructions.
8. Revoke access when refunds, failed payments, or abuse happen.
...
If the workbook is a free lead magnet or low-risk handout, use [MaiPDF Online Cloud Sharing](https://maipdf.com) with expiry, watermarks, and tracking.

If the workbook is paid, premium, easy to resell, or part of a course, use [MaiPDF App DRM](https://drm.maipdf.com) and deliver it as a protected `.maipdf` file.

For the broader education workflow, read [PDF DRM for Online Courses](/blog/en/pdf-drm-for-online-courses). If student forwarding is the main risk, read [How to Prevent Students from Sharing Course PDFs](/blog/en/how-to-prevent-students-from-sharing-course-pdfs).
